...
(@GOSSIP,0,2,'Please, loan me a Gryphon.',1,1,0,0,0,0,NULL),    -- Alliance
(@GOSSIP,1,2,'Please, loan me a Wind Rider.',1,1,0,0,0,0,NULL); -- Horde

UPDATE `creature_template` SET `gossip_menu_id`=@GOSSIP,`AIName`='SmartAI',`ScriptName`='' WHERE `entry`=@HONEST_MAX;
...
(@HONEST_MAX,0,0,2,62,0,100,0,@GOSSIP,0,0,0,11,60126,2,0,0,0,0,7,0,0,0,0,0,0,0,'"Honest" Max - on Gossip select - cast: Create Loaned Gryphon Reins'),    -- Alliance
(@HONEST_MAX,0,1,2,62,0,100,0,@GOSSIP,1,0,0,11,60128,2,0,0,0,0,7,0,0,0,0,0,0,0,'"Honest" Max - on Gossip select - cast: Create Loaned Wind Rider Reins'), -- Horde
