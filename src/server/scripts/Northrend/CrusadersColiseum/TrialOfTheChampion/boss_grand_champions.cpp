    ...
    struct boss_shaman_toc5AI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 const diff)
        {
            ...
            if (uiHealingWaveTimer <= diff)
            {
                ...
                if (!bChance)
                {
                    if (Unit* friendly = DoSelectLowestHpFriendly(40))
