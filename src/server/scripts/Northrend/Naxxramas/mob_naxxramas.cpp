...
struct mob_naxxramas_tashAI : public ScriptedAI
{
    mob_naxxramas_tashAI(Creature *c) : ScriptedAI(c)
    {
...
class mob_naxxramas_tash : public CreatureScript
{
public:
    mob_naxxramas_tash() : CreatureScript("mob_naxxramas_tash") { }
    ...
    struct mob_dread_creeperAI : mob_naxxramas_tashAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            mob_naxxramas_tashAI::UpdateAI(diff);
        }
    };
    // Carrion Spinner - 15975
